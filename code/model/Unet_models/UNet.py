...
class UNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=True, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        #
        self.outconv1 = nn.Conv2d(filters[0], n_classes, kernel_size = 1)
